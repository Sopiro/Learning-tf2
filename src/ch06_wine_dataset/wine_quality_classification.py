...
# DataFrame.loc[row, column] pick out the element specified by parameters
...
history = model.fit(train_X, train_Y, epochs=25, batch_size=32, validation_split=0.25, verbose=1)
